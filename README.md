...
| 2023年1月14日 | `info.plist`中屏幕旋转调整⭐️，压缩文件中`Podfile`内容调整⭐️⭐️，请使用最新对接文档 **对接文档_外部渠道20220114.zip** |
| 2023年1月27日 | `info.plist`里面权限更新； `RNFuzzyTribbleHelper` 方法名修改⭐️⭐️；`Podfile` 文件调整(文件最底部⭐️⭐️)； |
